...
const MeetingRoom = () => {
  ...
  return (
    <div
      className={`w-full h-screen relative grid ${user.role === "doctor" ? "grid-cols-[1.8fr_1fr]" : ""} gap-4 bg-white`}
    >
      ...
      {user.role === "doctor" ? (
        <div className="meetingRightBox bg-secondary/50 p-5 rounded-3xl flex flex-col gap-4 overflow-y-auto">
          {/* Patient Info */}
