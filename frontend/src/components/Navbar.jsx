    ...
    <nav className="fixed top-0 w-full h-24 flex items-center justify-between px-12 bg-white/60 backdrop-blur-xl z-[100] border-b border-white/20 shadow-sm">
      <div className="flex items-center gap-4 group cursor-pointer">
        <div className="w-14 h-14 flex items-center justify-center">
          <img src={logo} alt="HealthPulse Logo" className="w-full h-full object-contain" />
        </div>
        <div className="relative flex items-center">
          <span className="text-[#3F87F7] font-[1000] text-4xl tracking-tighter">HealthPulse</span>
            <img 
  src={plusIcon} 
  alt="plus" 
      ...
      <div className="flex items-center space-x-12">
        <ul className="hidden md:flex items-center space-x-10 text-[18px] font-bold text-slate-500">
          ...
          <li className="relative group">
            <Link to="/about" className="hover:text-blue-600 transition-colors cursor-pointer">
              About Us
            </Link>
